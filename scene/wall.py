def get_texture_metadata(sidedef, walltype):
    ...
    walltype_to_attr_suffix = {
        "UPPER": "top",
        "MIDDLE": "middle",
        "LOWER": "bottom"
    }

    walltype_to_attr_abbrev = {
        "UPPER": "top",
        "MIDDLE": "mid",
        "LOWER": "bottom"
    }
    ...
    offsetx = getattr(sidedef, f'offsetx_{abbr_suffix}', getattr(sidedef, 'offsetx', 0.0)) or 0.0
    offsety = getattr(sidedef, f'offsety_{abbrev_suffix}', getattr(sidedef, 'offsety', 0.0)) or 0.0
