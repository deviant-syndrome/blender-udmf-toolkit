...
def create_material_for_face_new(obj, face, face_index, wall_material_params: MaterialNodeParameters):
    ...
    try:
        ...
        tiling = wall_material_params.get_face_tiling(obj, face, face_index, texture_image)
        wall_material_params.preprocess_mesh_uv(obj, face_index)
        create_material_node_tree(material, texture_image, tiling, wall_material_params.texture_data)
